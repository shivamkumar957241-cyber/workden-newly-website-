...
const buttonVariants = cva(
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[transform,box-shadow,background-color,color,filter] duration-[var(--motion-duration-sm)] ease-[var(--motion-spring)] hover:-translate-y-0.5 hover:scale-[1.03] active:translate-y-0 active:scale-[0.97] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
...
function LiquidButton({
  ...
  return (
    ...
    >
      <div
        className="absolute inset-0 z-0 h-full w-full rounded-[inherit] bg-white/10 shadow-[0_0_6px_rgba(0,0,0,0.03),0_2px_6px_rgba(0,0,0,0.08),inset_3px_3px_0.5px_-3px_rgba(255,255,255,0.72),inset_-3px_-3px_0.5px_-3px_rgba(0,0,0,0.6),inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.65),inset_-1px_-1px_1px_-0.5px_rgba(0,0,0,0.35),inset_0_0_10px_4px_rgba(255,255,255,0.16),0_10px_28px_rgba(55,48,163,0.22)] transition-[box-shadow,opacity,transform] duration-[var(--motion-duration-sm)] ease-[var(--motion-spring)]"
      />
      <div
        className="absolute inset-0 isolate z-0 h-full w-full overflow-hidden rounded-[inherit]"
